...
def train_momentum_model(feature_filepath: str, stock_name: str):
    ...
    # --- MLOps Persistence Layer Block ---
    os.makedirs("data/models", exist_ok=True)
    model_save_path = f"data/models/{stock_name}_random_forest.joblib"
    joblib.dump(best_model, model_save_path)
    logger.info(f"💾 Saved trained weights for {stock_name} -> {model_save_path}")
    # --------------------------------------
